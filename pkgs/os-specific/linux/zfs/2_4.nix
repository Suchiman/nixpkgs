...
callPackage ./generic.nix args {
  ...
  extraPatches = [
    (fetchpatch2 {
      url = "https://github.com/openzfs/zfs/commit/8a9dc3bb70b861332ceb54017ccd7210a69a066c.patch?full_index=1";
      hash = "sha256-/CEATyuIUejgHFhynvpPmQZZPTz0/6miflXkTTgR1hw=";
    })
